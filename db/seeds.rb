...
Move.create!(category: 'Move', column: 2, move_number: 4, game: Game.all[0], player: Player.all[0])
Move.create!(category: 'Move', column: 1, move_number: 5, game: Game.all[0], player: Player.all[1])
Move.create!(category: 'Move', column: 1, move_number: 6, game: Game.all[0], player: Player.all[0])
Move.create!(category: 'Move', column: 2, move_number: 7, game: Game.all[0], player: Player.all[1])